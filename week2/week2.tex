...
\lhead{\footnotesize Graded Assignment: Week 2}% \lhead puts text in the top left corner. \footnotesize sets our font to a smaller size.
...
\begin{center} % Everything within the center environment is centered.
	{\Large \bf Graded Assignment: Week 2} % <---- Don't forget to put in the right number
	\vspace{2mm}
